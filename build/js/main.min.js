...
var searchLinkElement = document.querySelector('.delivery__suggestion');
var modalWindow = document.querySelector('.modal__container');
var cancelButton = modalWindow.querySelector('.modal__close-button');
var onDocumentKeydown = function onDocumentKeydown(evt) {
  if ((0, _utils.isEscapeKey)(evt)) {
    evt.preventDefault();
    closeModalWindow();
  }
};
...
var openModal = function openModal() {
  return searchLinkElement.addEventListener('click', openModalWindow);
};
...
},{"../js/utils/utils.js":15,"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
